	...
	\begin{enumerate*}
		...
		\begin{figure}[H]
			\begin{minipage}[h]{1\linewidth}
				\center{\includegraphics[scale=0.22]{3Engineering/1Brainstorming/images/01}}
				\caption{possible wheel bases}
				\label{poss_whl_bases}
			\end{minipage}
		\end{figure}
		% % % %
		...
		\begin{figure}[H]
			\begin{minipage}[h]{1\linewidth}
				\center{\includegraphics[scale=0.28]{3Engineering/1Brainstorming/images/02}}
