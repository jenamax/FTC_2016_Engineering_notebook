...
\begin{figure}[H]
	\begin{minipage}[h]{1\linewidth}
		\center{\includegraphics[scale=0.5]{days_L/Assembling/images/02}}
...
\begin{figure}[H]
	\begin{minipage}[h]{1\linewidth}
		\center{\includegraphics[scale=0.5]{days_L/Assembling/images/03}}
		\caption{The bucket for debris}
	\end{minipage}
\end{figure} 
\begin{figure}[H]
	\begin{minipage}[h]{1\linewidth}
		\center{\includegraphics[scale=0.5]{days_L/Assembling/images/04}}
...
\begin{figure}[H]
	\begin{minipage}[h]{1\linewidth}
		\center{\includegraphics[scale=0.5]{days_L/Assembling/images/05}}
		\caption{Cover closed}
	\end{minipage}
\end{figure} 
\begin{figure}[H]
	\begin{minipage}[h]{1\linewidth}
		\center{\includegraphics[scale=0.5]{days_L/Assembling/images/06}}
...
\begin{figure}[H]
	\begin{minipage}[h]{1\linewidth}
		\center{\includegraphics[scale=0.5]{days_L/Assembling/images/07}}
		\caption{Controllers}
	\end{minipage}
\end{figure} 
